...
Route::resource('material', 'App\Http\Controllers\Api\MaterialController')->only(['index','store','update','destroy','show']);
Route::resource('category', 'App\Http\Controllers\Api\CategoriesController')->only(['index','store','update','destroy','show']);
Route::resource('invoice', 'App\Http\Controllers\Api\InvoiceController')->only(['index','store','destroy']);
Route::resource('product', 'App\Http\Controllers\Api\ProductController')->only(['index','store','update','destroy', 'show']);
Route::resource('size', 'App\Http\Controllers\Api\SizeController')->only(['index','store','update','destroy','show']);
