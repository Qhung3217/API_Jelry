...
class InvoiceCollection extends ResourceCollection
{
    ...
    public function toArray($request)
    {
        return [
            ...
            'invoice_customer_province' => $this->invoice_customer_province,
            'invoice_customer_district' => $this->invoice_customer_district,
            'invoice_customer_ward' => $this->invoice_customer_ward,
